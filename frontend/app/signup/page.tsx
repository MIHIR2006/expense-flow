...
import { ArrowLeft, Building, Eye, EyeOff, Lock, Mail, MapPin, Phone, User } from "lucide-react";
          ...
          <CardHeader className="text-center space-y-2 pb-6">
            ...
            <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Select
                        ...
                        required
                      >
                        <SelectTrigger className="pl-10 bg-slate-700/50 border-slate-600 text-white focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 rounded-xl">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 pr-10 bg-slate-700/50 border-slate-600 text-white placeholder:text-slate-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 rounded-xl"
                        required
                      />
                      <button
                        type="button"
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  variant="outline"
                  className="bg-slate-700/50 border-slate-600 text-slate-200 hover:bg-slate-600/50 rounded-xl"
                >
